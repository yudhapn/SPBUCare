...
import com.pertamina.spbucare.databinding.FragmentWithdrawBinding
...
class WithdrawFragment : Fragment(), TextWatcher, View.OnClickListener {
    private lateinit var binding: FragmentWithdrawBinding
    private val orderVM: OrderViewModel by viewModel{ parametersOf("") }
    private val type = "tarik LO"
    ...
    private fun setEditTextListener() {
        binding.apply {
            etPremium.addTextChangedListener(this@WithdrawFragment)
            etBio.addTextChangedListener(this@WithdrawFragment)
            etPertamax.addTextChangedListener(this@WithdrawFragment)
            etPertalite.addTextChangedListener(this@WithdrawFragment)
            etDexlite.addTextChangedListener(this@WithdrawFragment)
            etPertadex.addTextChangedListener(this@WithdrawFragment)
            etTurbo.addTextChangedListener(this@WithdrawFragment)
        }
    }
            ...
            if (countType > 4) {
                ...
                MaterialAlertDialogBuilder(context)
                    ...
                    .setPositiveButton("Iya") { _, _ ->
                        ...
                        val action = WithdrawFragmentDirections.actionShowDashboard()
