...
import com.pertamina.spbucare.databinding.FragmentCancelBinding
...
class CancelFragment : Fragment(), TextWatcher, View.OnClickListener {
    ...
    private fun setEditTextListener() {
        binding.apply {
            etPremium.addTextChangedListener(this@CancelFragment)
            etBio.addTextChangedListener(this@CancelFragment)
            etPertamax.addTextChangedListener(this@CancelFragment)
            etPertalite.addTextChangedListener(this@CancelFragment)
            etDexlite.addTextChangedListener(this@CancelFragment)
            etPertadex.addTextChangedListener(this@CancelFragment)
            etTurbo.addTextChangedListener(this@CancelFragment)
        }
    }
            ...
            if (countType > 4) {
                ...
                MaterialAlertDialogBuilder(context)
                    ...
                    .setPositiveButton("Iya") { _, _ ->
                        ...
                        val action = CancelFragmentDirections.actionShowDashboard()
