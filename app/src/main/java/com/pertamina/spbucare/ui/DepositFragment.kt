...
import com.pertamina.spbucare.databinding.FragmentDepositBinding
...
class DepositFragment : Fragment(), TextWatcher, View.OnClickListener {
    ...
    private fun setEditTextListener() {
        binding.apply {
            etPremium.addTextChangedListener(this@DepositFragment)
            etBio.addTextChangedListener(this@DepositFragment)
            etPertamax.addTextChangedListener(this@DepositFragment)
            etPertalite.addTextChangedListener(this@DepositFragment)
            etDexlite.addTextChangedListener(this@DepositFragment)
            etPertadex.addTextChangedListener(this@DepositFragment)
            etTurbo.addTextChangedListener(this@DepositFragment)
        }
    }
            ...
            if (countType > 4) {
                ...
                MaterialAlertDialogBuilder(context)
                    ...
                    .setPositiveButton("Iya") { _, _ ->
                        ...
                        val action = DepositFragmentDirections.actionShowDashboard()
